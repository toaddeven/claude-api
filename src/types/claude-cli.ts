 ...
 * Claude CLI outputs newline-delimited JSON when run with --output-format stream-json
 */
...
export function isContentDelta(msg: ClaudeCliMessage): msg is ClaudeCliStreamEvent {
  return (
    ...
    (msg as ClaudeCliStreamEvent).event.type === "content_block_delta" &&
    (msg as ClaudeCliStreamEvent).event.delta?.type === "text_delta"
  );
}
